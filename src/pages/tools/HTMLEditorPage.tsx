  ...
  return (
    <>
      ...
      <main className="flex flex-col scroll-smooth" role="main">
        ...
        {/* ── RELATED TOOLS ── */}
        <RelatedTools currentTool="Visual HTML Sales Page Editor" />
        ...
        <section className="py-16 bg-gradient-primary text-primary-foreground" aria-label="Call to Action">
          <div className="container max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg opacity-90 mb-8">
              Get instant access to Visual HTML Sales Page Editor and all 3 other powerful tools included with{" "}
