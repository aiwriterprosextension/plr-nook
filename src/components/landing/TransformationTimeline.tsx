...
const milestones = [
  ...
  },
  {
    ...
    desc: "Learn and use all 7 built-in power tools",
  ...
  },
  {
    ...
    duration: "Ongoing",
    result: "5+ hours saved weekly = $1,000/month value",
  },
];
              ...
              {milestones.map((milestone, i) => (
                <div key={i} className="relative">
                  ...
                  <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
                    {i % 2 === 0 ? (
                      <>
                        ...
                        <div className="pl-12">
                          <div className="bg-accent border-2 border-primary/20 rounded-lg p-4">
                      ...
                      <>
                        <div className="text-right pr-12">
                          <div className="bg-accent border-2 border-primary/20 rounded-lg p-4 inline-block">
                            <div className="flex items-center gap-2 text-primary font-semibold">
                              <Check className="h-5 w-5" />
                              <span>{milestone.result}</span>
                            </div>
                  ...
                  <div className="md:hidden pl-20">
                    ...
                    <div className="mt-3 bg-accent border-2 border-primary/20 rounded-lg p-3">
